  ...
  <div class="reset-wallet">
    ...
    <div class="reset-wallet__wrap">
      <p class="reset-wallet__description">
        Resetting your wallet will clear all information from Self and take you
        back to create/recover wallet screen. You will be able to fully restore
        your wallet with your recovery phrase.
      </p>
